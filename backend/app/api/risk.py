...
@router.get("/summary")
async def risk_summary(region: str | None = None, district: str | None = None, city: str | None = None):
    villages = await enrich_settlements_with_weather(await get_live_settlements(region, district, city))
