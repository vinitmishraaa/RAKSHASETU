...
export default function Dashboard() {
  ...
  const dataRegion = useMemo(() => state === "Nepal" ? "Nepal" : state, [state]);
  ...
  return <div className="dashboard-page">
    <section className="dashboard-hero"><div><span className="eyebrow">DISASTER RESPONSE COMMAND CENTER</span><h1>RakshaSetu</h1><p>Country → State / Province → District → response intelligence.</p></div></section>
    ...
    {state && dataRegion && <RegionHistoryPanel region={dataRegion} district={district} />}
